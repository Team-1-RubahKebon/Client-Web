    ...
    <div>
      <div className="p-5 sm:ml-64">
        <div className="p-3 border-2 border-gray-200  rounded-lg dark:border-gray-700 mt-14">
          <div className="flex flex-col justify-center items-center h-[80vh] mb-5">
            <div
              className="relative flex flex-col items-center rounded-[20px] w-[700px] max-w-[95%] mx-auto bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!shadow-none p-3 drop-shadow-lg"
